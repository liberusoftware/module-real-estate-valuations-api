...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-real-estate-valuations-api?sort=semver)](https://github.com/liberusoftware/module-real-estate-valuations-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-real-estate-valuations-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-real-estate-valuations-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-real-estate-valuations-api
```
...
<a href="https://github.com/liberusoftware/module-real-estate-valuations-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-real-estate-valuations-api" alt="Contributors to liberusoftware/module-real-estate-valuations-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-real-estate-valuations-api/graphs/contributors).
